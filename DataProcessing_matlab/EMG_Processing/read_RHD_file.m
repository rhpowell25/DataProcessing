function [amplifier_data, amplifier_channels, t_amplifier, sample_rate, board_dig_in_data] = read_RHD_file(File_Name)
%%
...
trial_date = erase(File_Name, strcat('_', nondate_info));
...
tic;
load_File_Name = strcat(File_Name, '.rhd');
filename = [file_path, load_File_Name];
